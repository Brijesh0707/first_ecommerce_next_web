     ...
     <section className="w-[100%] h-[100%] flex justify-center items-center mt-[70px] mb-[110px]">
            <div className="w-[400px] rounded-lg border-2 pl-3 pr-3 pt-3 pb-3 mt-20">
              ...
              <p className='text-[20px] w-[100%] text-base_color font-800 pt-2 pb-2 text-center font-lato bg-gray-100 '>Brij-Ecommerce 🛒</p>
                ...
                <input type="text" placeholder="enter your username" className="w-[100%] pt-2 pb-2 pl-2 border-[1px] border-black rounded-md mt-2 mb-2"/>


                <br/>
                <br/>
                <p>You have account <Link href="/login" className="text-blue-500 underline">Login Your Account</Link></p>
                <br/>

                <button className="w-[100%] h-[30px] bg-bgg_base text-white rounded-lg">Register</button>
            </div>
        </section>
   </>
  )
